...
class AnimationWidget extends StatefulWidget {
  final Widget child;
  final int delay;
  const AnimationWidget({ Key? key , required this.child , required this.delay }) : super(key: key);
...
class _AnimationWidgetState extends State<AnimationWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return FadeTransition(opacity: _controller , child: SlideTransition(position: _animOffset, child: widget.child,),);
  }
}